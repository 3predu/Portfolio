    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4">
      <nav
        className="
                    ...
                    backdrop-blur-lg bg-gray-950/50 rounded-full 
                    shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2),0_2px_8px_0_rgba(0,0,0,0.16)] border-white/20 border-[0.5px]
                "
      >
        {/* Logo */}
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="absolute top-14 left-6 right-6 backdrop-blur-xl rounded-2xl p-5 flex flex-col items-start gap-6 md:hidden
                                mt-6 mx-auto max-w-6xl px-6 py-3 justify-between bg-gray-950/50
                                shadow-[inset_0_1px_0_0_rgba(255,255,255,0.2),0_2px_8px_0_rgba(0,0,0,0.16)] border-white/20 border-[0.5px]
                            "
            >
              {NavLinks.map((link) => (
